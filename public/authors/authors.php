...
<body class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
    <section>
        <div class="flex flex-col justify-center items-center mt-8 mb-4">
            ...
            <a href="../books/books.php" class="text-xl font-extrabold text-indigo-600 sm:text-xl md:text-xl">
                Books
            </a>
        </div>
                            ...
                            <?php foreach ($authors as $author): ?>
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <th class="px-4 py-3 flex items-center justify-center space-x-4">
                                        <a href="update.php?id=<?= $author["id"] ?>" class="text-sm text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg px-3 py-2">
